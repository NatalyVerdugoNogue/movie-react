    ...
    <div className="film card-movie">
      ...
      <Link to={`/film/${film.id}`}>
        <Card className='small font-card back-card' key={film.id}
          header={
            <CardTitle image={film.poster_path ? `https://image.tmdb.org/t/p/w500${film.poster_path}` : notfound}>
            </CardTitle>}>
      ...
      <Button className='favorite-button' type='submit' onClick={() => saveFavoriteFilms(film)} waves='light'>
